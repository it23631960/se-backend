...
public interface SalonRepository extends MongoRepository<Salon, String> {
    ...
    /**
     * Find salons by type (e.g., hair-salon, barber-shop, nail-salon, bridal-salon)
     * 
     * @param type Type of salon
     * @return List of salons matching the type
     */
    List<Salon> findByType(String type);
}